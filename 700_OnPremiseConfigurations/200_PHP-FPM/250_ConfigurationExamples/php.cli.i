...
System => Linux 6.8.0-64-generic #67-Ubuntu SMP PREEMPT_DYNAMIC Sun Jun 15 20:23:31 UTC 2025 x86_64
Build Date => Mar 13 2025 18:13:49
Build System => Linux
...
Registered Stream Filters => zlib.*, string.rot13, string.toupper, string.tolower, convert.*, consumed, dechunk, convert.iconv.*, mcrypt.*, mdecrypt.*
...
Client API library version => mysqlnd 8.2.28
...
Client API version => mysqlnd 8.2.28
...
session.gc_maxlifetime => 31536000 => 31536000
...
SSH_CONNECTION => 0.0.250.1 57636 0.0.1.132 22
...
$_SERVER['PWD'] => /home/myuser
$_SERVER['LOGNAME'] => myuser
$_SERVER['XDG_SESSION_TYPE'] => tty
$_SERVER['HOME'] => /home/myuser
...
$_SERVER['SSH_CONNECTION'] => 0.0.250.1 57636 0.0.1.132 22
...
$_SERVER['USER'] => myuser
$_SERVER['SHLVL'] => 1
$_SERVER['XDG_SESSION_ID'] => 3096
$_SERVER['XDG_RUNTIME_DIR'] => /run/user/1001
$_SERVER['SSH_CLIENT'] => 0.0.250.1 57636 22
...
$_SERVER['DBUS_SESSION_BUS_ADDRESS'] => unix:path=/run/user/1001/bus
...
$_SERVER['REQUEST_TIME_FLOAT'] => 1753820237.4753
$_SERVER['REQUEST_TIME'] => 1753820237
$_SERVER['argv'] => Array
(
)
